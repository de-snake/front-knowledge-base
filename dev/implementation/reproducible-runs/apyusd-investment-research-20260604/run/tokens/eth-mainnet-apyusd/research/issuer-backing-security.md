...
|---|---|---:|---:|---:|---:|---|
| S1 | `run/tokens/eth-mainnet-apyusd/research/onchain-admin.md` and raw snapshots | onchain | current | 2026-06-04 | high | Exact token identity, implementation, AccessManager, role holders, pause/deny-list/current totalAssets and totalSupply. |
...
| S10 | `run/methodology.md` | unknown | current | 2026-06-04 | high | Report labels and missing-data behavior. |
