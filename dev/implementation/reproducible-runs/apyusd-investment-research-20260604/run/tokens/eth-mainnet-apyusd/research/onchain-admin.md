...
|---|---|---:|---:|---:|---:|---|
| S1 | `https://ethereum-rpc.publicnode.com` plus raw snapshot `run/tokens/eth-mainnet-apyusd/research/raw/onchain-admin-snapshot-2026-06-04.json` | onchain | current | 2026-06-04 | high | Direct Ethereum mainnet RPC calls at block `25243724` for apyUSD, its AccessManager, and Safe-compatible role holder. |
...
| S7 | `run/methodology.md` | unknown | current | 2026-06-04 | high | Methodology labels and missing-data behavior used by this artifact. |
...
RPC freshness note: current values above were checked against Ethereum public RPC at block `25243724` on 2026-06-04. A raw replay/evidence snapshot is stored at `run/tokens/eth-mainnet-apyusd/research/raw/onchain-admin-snapshot-2026-06-04.json`.
