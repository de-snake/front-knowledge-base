...
| S17 | Project methodology, `run/methodology.md` | unknown | 2026-06-04 | high | Source-priority rules, asset-section requirements, `missing_behavior` labels. |
