# Stage packet — S1_general_asset_mining — eth-mainnet-susdat
...
Mandatory facts:
- `asset.S1_general_asset_mining.eth-mainnet-susdat.scope_loaded` — stage scope, input paths, and required outputs are loaded before claims (if unresolved: `not_investigated`)
- `asset.S1_general_asset_mining.eth-mainnet-susdat.f1_token-identity-address-chain-decimals-with-sourc` — token identity/address/chain/decimals with source path (if unresolved: `not_investigated`)
- `asset.S1_general_asset_mining.eth-mainnet-susdat.f2_admin-proxy-mint-freeze-pause-transfer-and-upgra` — admin, proxy, mint, freeze, pause, transfer, and upgrade controls (if unresolved: `not_investigated`)
- `asset.S1_general_asset_mining.eth-mainnet-susdat.f3_issuer-backing-redemption-security-facts` — issuer/backing/redemption/security facts (if unresolved: `not_investigated`)
- `asset.S1_general_asset_mining.eth-mainnet-susdat.f4_transferability-liquidity-oracle-and-governance-` — transferability, liquidity, oracle, and governance constraints (if unresolved: `not_investigated`)
...
- `tokens/eth-mainnet-susdat/research/onchain-admin.md`
- `tokens/eth-mainnet-susdat/research/issuer-backing-security.md`
- `tokens/eth-mainnet-susdat/research/transfer-liquidity-oracle-governance.md`
