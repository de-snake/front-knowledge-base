# Stage packet — S1_general_asset_mining — eth-mainnet-usdat
...
- Artifact directory: `tokens/eth-mainnet-usdat`
...
Input paths:
- `tokens/eth-mainnet-usdat/scope.json`
...
Mandatory facts:
- `asset.S1_general_asset_mining.eth-mainnet-usdat.scope_loaded` — stage scope, input paths, and required outputs are loaded before claims (if unresolved: `not_investigated`)
- `asset.S1_general_asset_mining.eth-mainnet-usdat.f1_token-identity-address-chain-decimals-with-sourc` — token identity/address/chain/decimals with source path (if unresolved: `not_investigated`)
- `asset.S1_general_asset_mining.eth-mainnet-usdat.f2_admin-proxy-mint-freeze-pause-transfer-and-upgra` — admin, proxy, mint, freeze, pause, transfer, and upgrade controls (if unresolved: `not_investigated`)
- `asset.S1_general_asset_mining.eth-mainnet-usdat.f3_issuer-backing-redemption-security-facts` — issuer/backing/redemption/security facts (if unresolved: `not_investigated`)
- `asset.S1_general_asset_mining.eth-mainnet-usdat.f4_transferability-liquidity-oracle-and-governance-` — transferability, liquidity, oracle, and governance constraints (if unresolved: `not_investigated`)
...
```json
{
  ...
  "proof_id": "asset.S1_general_asset_mining.<fact>.no_result.v1",
...
- `tokens/eth-mainnet-usdat/research/onchain-admin.md`
- `tokens/eth-mainnet-usdat/research/issuer-backing-security.md`
- `tokens/eth-mainnet-usdat/research/transfer-liquidity-oracle-governance.md`
- `tokens/eth-mainnet-usdat/technical-report.md`
