# Stage packet — S4_stress_tradeoff_analysis — eth-mainnet-susdat-gearbox-oracle
...
- Artifact directory: `tokens/eth-mainnet-susdat-gearbox-oracle`
...
Input paths:
- `tokens/eth-mainnet-susdat-gearbox-oracle/oracle/feed-graph.md`
- `tokens/eth-mainnet-susdat-gearbox-oracle/oracle/source-primitive-audit.md`
...
Mandatory facts:
- `oracle.S4_stress_tradeoff_analysis.eth-mainnet-susdat-gearbox-oracle.scope_loaded` — stage scope, input paths, and required outputs are loaded before claims (if unresolved: `not_investigated`)
- `oracle.S4_stress_tradeoff_analysis.eth-mainnet-susdat-gearbox-oracle.f1_borrower-pool-liquidator-side-specific-stress-sc` — borrower/pool/liquidator side-specific stress scenarios (if unresolved: `not_investigated`)
- `oracle.S4_stress_tradeoff_analysis.eth-mainnet-susdat-gearbox-oracle.f2_size-liquidity-staleness-redemption-and-route-as` — size, liquidity, staleness, redemption, and route assumptions (if unresolved: `not_investigated`)
- `oracle.S4_stress_tradeoff_analysis.eth-mainnet-susdat-gearbox-oracle.f3_tradeoff-conclusion-derived-from-fact-states-rat` — tradeoff conclusion derived from fact states rather than placeholder gaps (if unresolved: `not_investigated`)
...
```json
{
  ...
  "proof_id": "oracle.S4_stress_tradeoff_analysis.<fact>.no_result.v1",
...
- `tokens/eth-mainnet-susdat-gearbox-oracle/oracle/stress-tradeoff-analysis.md`
