# Stage packet — S6_final_verification — eth-mainnet-susdat-gearbox-oracle
...
Mandatory facts:
- `oracle.S6_final_verification.eth-mainnet-susdat-gearbox-oracle.scope_loaded` — stage scope, input paths, and required outputs are loaded before claims (if unresolved: `not_investigated`)
- `oracle.S6_final_verification.eth-mainnet-susdat-gearbox-oracle.f1_oracle-output-files-and-final-indexes-exist` — oracle output files and final indexes exist (if unresolved: `not_investigated`)
- `oracle.S6_final_verification.eth-mainnet-susdat-gearbox-oracle.f2_feed-source-protocol-fit-fact-states-are-summari` — feed/source/protocol-fit fact states are summarized (if unresolved: `not_investigated`)
- `oracle.S6_final_verification.eth-mainnet-susdat-gearbox-oracle.f3_final-oracle-status-is-consistent-with-unresolve` — final oracle status is consistent with unresolved fact decision effects (if unresolved: `not_investigated`)
...
```json
{
  ...
  "proof_id": "oracle.S6_final_verification.<fact>.no_result.v1",
...
- `tokens/eth-mainnet-susdat-gearbox-oracle/verification/oracle-analysis-verification.md`
