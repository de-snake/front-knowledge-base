# Stage packet — S3_source_primitive_audit — eth-mainnet-usdat-gearbox-oracle
...
Input paths:
- `tokens/eth-mainnet-usdat-gearbox-oracle/oracle/node-classification.md`
...
Mandatory facts:
- `oracle.S3_source_primitive_audit.eth-mainnet-usdat-gearbox-oracle.scope_loaded` — stage scope, input paths, and required outputs are loaded before claims (if unresolved: `not_investigated`)
- `oracle.S3_source_primitive_audit.eth-mainnet-usdat-gearbox-oracle.f1_source-primitive-authority-freshness-update-path` — source primitive authority, freshness, update path, and manipulation surface (if unresolved: `not_investigated`)
- `oracle.S3_source_primitive_audit.eth-mainnet-usdat-gearbox-oracle.f2_raw-source-evidence-saved-for-every-checked-prim` — raw source evidence saved for every checked primitive (if unresolved: `not_investigated`)
- `oracle.S3_source_primitive_audit.eth-mainnet-usdat-gearbox-oracle.f3_negative-source-searches-include-no-result-proof` — negative source searches include no-result proof bundles (if unresolved: `not_investigated`)
...
- `tokens/eth-mainnet-usdat-gearbox-oracle/oracle/source-primitive-audit.md`
- `tokens/eth-mainnet-usdat-gearbox-oracle/raw/source-evidence/`
