# Stage packet — S1_feed_inventory_and_graph — eth-mainnet-usdat-gearbox-oracle
...
Input paths:
- `tokens/eth-mainnet-usdat-gearbox-oracle/oracle/scope.md`
...
Mandatory facts:
- `oracle.S1_feed_inventory_and_graph.eth-mainnet-usdat-gearbox-oracle.scope_loaded` — stage scope, input paths, and required outputs are loaded before claims (if unresolved: `not_investigated`)
- `oracle.S1_feed_inventory_and_graph.eth-mainnet-usdat-gearbox-oracle.f1_feed-contract-inventory-and-dependency-graph` — feed contract inventory and dependency graph (if unresolved: `not_investigated`)
- `oracle.S1_feed_inventory_and_graph.eth-mainnet-usdat-gearbox-oracle.f2_recursive-source-node-discovery-with-raw-probe-a` — recursive source-node discovery with raw probe artifacts (if unresolved: `not_investigated`)
- `oracle.S1_feed_inventory_and_graph.eth-mainnet-usdat-gearbox-oracle.f3_missing-feed-dependency-results-represented-as-f` — missing feed/dependency results represented as fact states, not prose placeholders (if unresolved: `not_investigated`)
...
- `tokens/eth-mainnet-usdat-gearbox-oracle/oracle/feed-graph.md`
- `tokens/eth-mainnet-usdat-gearbox-oracle/raw/feed-probes.json`
