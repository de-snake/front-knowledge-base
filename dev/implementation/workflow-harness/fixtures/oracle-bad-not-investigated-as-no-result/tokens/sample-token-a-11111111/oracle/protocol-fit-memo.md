...
- Market or Credit Manager: state=investigated_no_result despite not_investigated; no market / no credit manager not investigated. Registry checked, contract query attempted, network Ethereum mainnet, evidence path raw/feed-probes.json.
...
- Route availability: execution route and liquidation route availability reviewed; route status unknown marker recorded, not inferred.
