...
Command: python3 dev/tools/validate_workflow_run.py --workflow asset-investment-diligence --run-root /Users/ilya/Documents/Codex/front-knowledge-base/dev/implementation/workflow-harness/fixtures/asset-bad-missing-token-file --format json
Exit status: 0
