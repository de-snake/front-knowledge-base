# Investment analyst report: points PT risk return
...
## Decision effect
Request position size, target leverage, hold horizon, and user risk policy before Preview. Do not treat this report as allocation sizing or execution approval.
