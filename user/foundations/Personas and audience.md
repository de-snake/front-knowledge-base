...
| **Institutional / tokenized-asset allocator** | cares about all of the above plus issuer / eligibility risks (freeze authority, eligible-liquidator depth, redemption mechanics). |
...
| and — for issuer-controlled collateral exposure — frozen accounts and liquidator scarcity | read issuer / collateral terms, verify liquidation liquidity available | 2 |
...
| **Issuer-controlled collateral user** | wants leverage on tokenized securities or other controlled assets; additionally cares about freeze authority, redemption windows, and eligibility / KYC validity. |
...
|issuer intervention| Read T&C, be a good guy | 1 |
